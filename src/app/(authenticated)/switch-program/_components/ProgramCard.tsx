...
import OrganizationSvg from '@/components/svgs/common/OrganizationSvg';
import StarSvg from '@/components/svgs/common/Star';
import { useAppSelector } from '@/redux/hooks';
import { TBootcampResult } from '@/types';
import {
    ArrowRight,
    Package,
    CheckCircle,
