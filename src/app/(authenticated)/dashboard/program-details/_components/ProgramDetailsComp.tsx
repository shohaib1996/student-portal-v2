...
export default function ProgramDetailsComp({ slug }: { slug: string }) {
    ...
    const modules: Module[] = [
        {
            id: 'module-1',
            title: 'Welcome To TS4U Onboarding And Expectation',
            lectures: 15,
            duration: '1h 30m',
            progress: 80,
            lessons: [
        ...
        {
            id: 'module-5',
            title: 'Assignment: Bring More Value to Your Pitch Deck',
            lectures: 1,
            duration: '30m',
            progress: 0,
            lessons: [
    ...
    return (
        <div className='bg-background border-t border-border pt-2'>
            <GlobalHeader
                ...
                tooltip='AWS DevOps and CloudOps Engineer'
                buttons={
                        ...
                        <Button variant='primary_light' className=''>
                            <span>
                                <svg
                                    ...
                                    fill='none'
                                >
                                    <g clip-path='url(#clip0_336_46691)'>
                                        <path
