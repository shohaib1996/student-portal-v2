                    ...
                    <div className=''>
                        ...
                        <div>
                            ...
                            <p className='text-gray line-clamp-2'>
                                Master cloud infrastructure, CI/CD pipelines,
                                and automation with our comprehensive AWS DevOps
                                program. Gain hands-on experience with
                        ...
                        <div className='shadow border rounded-md p-2.5 my-3'>
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                                <div className='bg-green-50 rounded-lg p-4 flex items-center gap-2.5'>
                                    <div className='h-[38px] w-[38px] flex items-center justify-center rounded-sm bg-gray'>
