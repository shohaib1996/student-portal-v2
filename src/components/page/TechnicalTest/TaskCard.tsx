...
export default function TaskCard({ task }: TaskCardProps) {
        ...
        switch (status) {
            case 'completed':
                return (
                    <Badge
                        variant='outline'
                        className='bg-white text-blue-800 border-blue-200 rounded-md py-1 px-2 flex items-center gap-1 font-medium text-xs absolute top-3 left-3 z-10'
                    >
                        <svg
            ...
            case 'pending':
                return (
                    <Badge
                        variant='outline'
                        className='bg-white text-amber-800 border-amber-200 rounded-md py-1 px-2 flex items-center gap-1 font-medium text-xs absolute top-3 left-3 z-10'
                    >
                        <svg
                            xmlns='http://www.w3.org/2000/svg'
                            width='18'
            ...
            case 'rejected':
                return (
                    <Badge
                        variant='outline'
                        className='bg-white text-red-800 border-red-200 rounded-md py-1 px-2 flex items-center gap-1 font-medium text-xs absolute top-3 left-3 z-10'
                    >
                        <svg
                            className='w-4 h-4'
                            viewBox='0 0 24 24'
            ...
            default:
                return (
                    <Badge
                        variant='outline'
                        className='bg-white text-gray-800 border-gray-200 rounded-md py-1 px-2 flex items-center gap-1 font-medium text-xs absolute top-3 left-3 z-10'
                    >
                        <svg
                            xmlns='http://www.w3.org/2000/svg'
                            width='16'
    ...
    return (
        <Card className='overflow-hidden rounded-xl border border-blue-100 bg-blue-50'>
            <div className='flex flex-col md:flex-row p-[10px] gap-[10px]'>
                <div className='relative rounded-lg h-[140px] w-[180px]'>
                ...
                <div className='flex-1'>
                    ...
                    <div className='border-t border-[#546A7E26] pt-1.5 mt-auto'>
                        <div className='flex gap-4'>
                            <Button className='bg-[#0736D1] hover:bg-blue-500 text-white rounded-md px-3.5 py-2.5 h-auto'>
                                Test Now <span className='ml-1'>→</span>
                            </Button>
                            <Button
                                variant='outline'
                                className='text-[#5C5958] bg-pure-white border-gray-200 hover:bg-gray-50 rounded-md px-3.5 py-2 h-auto flex items-center gap-2'
                            >
