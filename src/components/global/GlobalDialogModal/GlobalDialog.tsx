...
type GlobalDialogProps = {
    ...
    className?: string;
    bgColor?: 'bg-foreground' | 'bg-background';
        ...
        return (
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent
                    ref={ref}
                    className={cn(
                        `global_dialog_modal p-0 ${bgColor} rounded-lg w-[90vw] sm:w-[600px] md:w-[700px] lg:w-[800px] max-w-[95%] sm:max-w-[90%] max-h-[90vh] relative flex flex-col fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] gap-2 border`,
                        className,
                        isFullScreen &&
                ...
                >
                    ...
                    {customTitle
                        ...
                        : header && (
                              <div
                                  className={`flex items-center justify-between border-b px-5 py-3 pb-2 sticky top-0 rounded-tr-lg rounded-tl-lg ${bgColor} z-10`}
                              >
                                  <div>
