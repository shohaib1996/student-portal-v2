...
import SpinIcon from '../svgs/calendar/SpinIcon';
import ExportIcon from '../svgs/calendar/ExportIcon';
import ImportIcon from '../svgs/calendar/ImportIcon';
import SortIcon from '../svgs/calendar/SortIcon';
import RecycleIcon from '../svgs/calendar/RecycleIcon';
    ...
    'inline-flex items-center justify-center gap-1 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0',
    {
        variants: {
            variant: {
                ...
                secondary:
                    'bg-foreground text-dark-gray hover:bg-foreground border border-secondary-border',
                primary_light:
