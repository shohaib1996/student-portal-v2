        ...
        <div className='w-full flex'>
            <Form {...form}>
                <form
                    ...
                    className={cn('gap-2 grid grid-cols-5 w-full', {
                        'grid-cols-10': isFullScreen,
                    })}
                >
                    {/* Event Name */}
                    <FormField
                    ...
                    {/* Date and Time */}
                    <div className='border border-forground-border bg-foreground rounded-md p-2 col-span-5'>
                        <div className='space-y-2'>
                            {/* Date Picker */}
