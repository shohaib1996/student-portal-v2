    ...
    useEffect(() => {
        const onMouseMove = (event: MouseEvent) => {
            setTimeout(() => {
                ...
                if (
                    resizerRef.current &&
                    resizerRef.current.contains(target as Node)
                ) {
                    return;
                }
                ...
                if (targetRef.current !== target) {
                    ...
                    if (cell && activeCell !== cell) {
                        editor.update(() => {
                            ...
                            if (!tableElement) {
                                throw new Error(
                                    'TableCellResizer: Table element not found.',
                                );
                            }
                ...
                () => {
                    ...
                    if (height === undefined) {
                        ...
                        height = Math.min(
                            ...rowCells.map(
                                (cell) =>
                                    getCellNodeHeight(cell, editor) ?? Infinity,
                            ),
                        );
                    }
            ...
            editor.update(
                () => {
                    ...
                    if (columnIndex === undefined) {
                        throw new Error(
                            'TableCellResizer: Table column not found.',
                        );
                    }
