                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align='start' className='w-56'>
                            ...
                            <DropdownMenuGroup>
                                ...
                                <DropdownMenuItem
                                    onClick={() => transformText('shorter')}
                                >
                                    <Scissors className='mr-2 h-4 w-4' />
                                    <span>Make shorter</span>
                                </DropdownMenuItem>
                                <DropdownMenuItem
                                    onClick={() => transformText('longer')}
                                >
                                    <Maximize className='mr-2 h-4 w-4' />
                                    <span>Make longer</span>
                                </DropdownMenuItem>
                                <DropdownMenuItem
                                    onClick={() => transformText('summarize')}
                                >
                                    <Minimize className='mr-2 h-4 w-4' />
                                    <span>Summarize</span>
                                </DropdownMenuItem>
                                <DropdownMenuItem
                                    onClick={() => transformText('continue')}
                                >
                            ...
                            <DropdownMenuSub>
                                ...
                                <DropdownMenuSubContent>
                                    <DropdownMenuItem
                                        onClick={() =>
                                            transformText('tone-professional')
                                        }
                                    >
                                        Professional
                                    </DropdownMenuItem>
                            ...
                            <DropdownMenuSub>
                                ...
                                <DropdownMenuSubContent>
                                    ...
                                    <DropdownMenuItem
                                        onClick={() =>
                                            transformText('style-persuasive')
                                        }
                                    >
                                        Persuasive
                                    </DropdownMenuItem>
                            ...
                            <DropdownMenuSub>
                                ...
                                <DropdownMenuSubContent>
                                    <DropdownMenuItem
                                        onClick={() =>
                                            transformText('translate-english')
                                        }
                                    >
                                        English
                                    </DropdownMenuItem>
                                    <DropdownMenuItem
                                        onClick={() =>
                                            transformText('translate-spanish')
                                        }
                                    >
                                        Spanish
                                    </DropdownMenuItem>
                                    <DropdownMenuItem
                                        onClick={() =>
                                            transformText('translate-french')
                                        }
                                    >
                                        French
                                    </DropdownMenuItem>
                                    <DropdownMenuItem
                                        onClick={() =>
                                            transformText('translate-german')
                                        }
                                    >
                                        German
                                    </DropdownMenuItem>
                                    <DropdownMenuItem
                                        onClick={() =>
                                            transformText('translate-chinese')
                                        }
                                    >
                                        Chinese
                                    </DropdownMenuItem>
                                    <DropdownMenuItem
                                        onClick={() =>
                                            transformText('translate-japanese')
                                        }
                                    >
                                        Japanese
                                    </DropdownMenuItem>
                                    <DropdownMenuItem
                                        onClick={() =>
                                            transformText('translate-arabic')
                                        }
                                    >
                                        Arabic
                                    </DropdownMenuItem>
                                    ...
                                    <DropdownMenuItem
                                        onClick={() =>
                                            transformText('translate-bangla')
                                        }
                                    >
                                        Bangla (Bengali)
                                    </DropdownMenuItem>
                                ...
                                onClick={() => {
                                    ...
                                    editor.update(() => {
                                        ...
                                        const customPrompt = window.prompt(
                                            ...
                                            `Transform the following text: "${selectedText}"`,
                                        );
